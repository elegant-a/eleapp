...
<div class="shopcart">
  ...
  <div class="cartview-cartmask" v-if="showCartView && !isEmpty" @click.self="showCartView=false">
      ...
      <div class="entityList-cartbodyScroller">
        <ul class="entityList-cartlist">
          <li class="entityList-entityrow" v-for="(food,index) in selectFoods" :key="index">
            ...
            <span class="entityList-entitytotal">{{food.activity.fixed_price * food.count}}</span>
