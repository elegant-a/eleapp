<template>
  <div class="order">
     <div class="order-card-body" v-for="(order,index) in orderlist" :key="index" v-if="order.orderInfo">
       <div @click="$router.push({name:'orderInfo',params:order})" class="order-card-wrap">
       ...
       <div class="order-card-bottom">
         <button class="card-button" @click="$router.push({name:'orderInfo',params:order})">再来一单</button>
       </div>
     </div>
  </div>
</template>
