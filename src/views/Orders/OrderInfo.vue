<template>
   <div class="orderInfo">
   <Header title="订单详情" :is-left="true"/>
     <div class="view-body" v-if="orderDetail">
       <div class="status-head">
         <div class="status-text">订单已送达</div>
         <div class="status-title">感谢您对我们的信任,期待再次光临</div>
       </div>
<!--       商品信息-->
       <div class="restaurant-card">
<!--         点餐信息-->
         <CartGroup v-if="orderDetail.orderInfo" :orderInfo="orderDetail.orderInfo" :total-price="orderDetail.totalPrice"/>
       </div>
<!--       配送信息-->
...
<!--       订单信息-->
       <div class="detail-card">
         ...
         <ul class="card-list">
           ...
           <li v-if="orderDetail.remarkInfo" class="list-item">
             <span>订单备注:</span>
